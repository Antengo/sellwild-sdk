...
abstract final class SellwildFailureCode {
  ...
  static const String listingsUrlInvalid = 'listings.url.invalid';
  ...
  /// A WebView setup call (JavaScript mode, channel, navigation delegate or
  /// loadHtmlString) threw, so the widget or banner page never loads.
  static const String widgetWebviewLoadException =
      'widget.webview_load.exception';
