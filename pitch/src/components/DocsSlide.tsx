...
import { BG, TEXT, TEXT_DIM, ACCENT } from './theme'
...
export const DocsSlide = () => {
  ...
  const glowOpacity = interpolate(frame, [15, 40], [0, 0.35], { extrapolateRight: 'clamp' })
    ...
    <div style={base}>
      ...
      <div style={{
        ...
        <p style={{ fontSize: 18, color: TEXT_DIM, marginTop: 8 }}>
          iOS, Android, React Native, Flutter — full integration guides
        </p>
      </div>

      {/* Docs screenshot in browser frame */}
      <div style={{
        marginTop: 80,
        ...
        <div style={browserFrame}>
          <div style={browserBar}>
            ...
            <div style={browserUrl}>sdk.sellwild.com/guide</div>
          </div>
          <Img src={staticFile('sellwild-sdk-docs.gif')} style={browserContent} />
        </div>
      </div>
    </div>
  )
